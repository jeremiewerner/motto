...
- [x] **DOC-05**: README scaffold section rewritten around `motto init`; `skills/setup-project/` deleted in the same commit as the dogfood-test count update (main never red)
